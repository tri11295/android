...
//            val soundIphoneUriGame  = Uri.parse("android.resource://" + packageName + "/" + R.raw.iphonesound)
...
//            mChannelGame.setSound(soundIphoneUriGame,attributesGame)
            ...
            val soundIphoneUri  = Uri.parse("android.resource://" + packageName + "/" + R.raw.iphonesound)
